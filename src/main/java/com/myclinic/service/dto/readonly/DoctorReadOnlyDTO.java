...
/**
 * The {@link DoctorReadOnlyDTO} class is the DTO equivalent of the
 * {@link Doctor} class, adjusted for read-only operations.
...
public class DoctorReadOnlyDTO extends BaseDTO {
	...
	public DoctorReadOnlyDTO(Long id,String firstname, String lastname, SpecialtyType specialty, String phoneNumber,
