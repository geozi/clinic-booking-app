...
/**
 * The {@link AppointmentUpdateDTO} class is the DTO equivalent of the
 * {@link Appointment} class, adjusted for updating operations.
 * It inherits from the {@link BaseDTO} class.
 */
@NoArgsConstructor
@Getter
@Setter
public class AppointmentUpdateDTO extends BaseDTO {
	...
	public AppointmentUpdateDTO(Long id, LocalDate appointmentDate, LocalTime time, StatusType status, Patient patient,
